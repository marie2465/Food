...
import com.myitschool.newtravel.restourant.activity.MenuOnlineActivity;
import com.myitschool.newtravel.restourant.activity.TableOnlineActivity;
import com.myitschool.newtravel.restourant.activity.VitrinaActivity;
import com.myitschool.newtravel.restourant.fragments.MenuOnlineFragment;
...
public class CircleMenuView extends FrameLayout {
    ...
    private FloatingActionButton packet1;
    private FloatingActionButton packet2;
    private FloatingActionButton packet3;
    private FloatingActionButton packet4;
    private FloatingActionButton packet5;
    private FloatingActionButton packet6;
    ...
    private class OnPacket1ButtonClickListener implements OnClickListener {
        @Override
        public void onClick(final View view) {
            ...
            Anim(view);
            Intent intent=new Intent(getContext(), TableOnlineActivity.class);
    ...
    private class OnPacket2ButtonClickListener implements OnClickListener {
        @Override
        public void onClick(final View view) {
            if (mIsAnimating) {
                return;
            ...
            Anim(view);
            Intent intent=new Intent(getContext(), VitrinaActivity.class);
            intent.putExtra("id",id);
            getContext().startActivity(intent);
        }
    }

    private class OnPacket3ButtonClickListener implements OnClickListener {
        @Override
        public void onClick(final View view) {
            if (mIsAnimating) {
                return;
            ...
            Anim(view);
            Intent intent=new Intent(getContext(), MenuOnlineActivity.class);
            intent.putExtra("id",id);
            getContext().startActivity(intent);
        }
    }

    private class OnPacket4ButtonClickListener implements OnClickListener {
        @Override
        public void onClick(final View view) {
            if (mIsAnimating) {
                return;
    ...
    private class OnPacket5ButtonClickListener implements OnClickListener {
        @Override
        public void onClick(final View view) {
            if (mIsAnimating) {
                return;
    ...
    private class OnPacket6ButtonClickListener implements OnClickListener {
        @Override
        public void onClick(final View view) {
            if (mIsAnimating) {
                return;
    ...
    private void initButtons(@NonNull Context context, @NonNull List<Integer> icons, @NonNull List<Integer> colors) {
        ...
        packet1 = new FloatingActionButton(context);
        packet1.setImageResource(icons.get(0));
        packet1.setBackgroundTintList(ColorStateList.valueOf(colors.get(0)));
        packet1.setClickable(true);
        packet1.setOnClickListener(new OnPacket1ButtonClickListener());
        packet1.setOnLongClickListener(new OnButtonLongClickListener());
        packet1.setScaleX(0);
        packet1.setScaleY(0);
        packet1.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
        addView(packet1);

        packet2 = new FloatingActionButton(context);
        packet2.setImageResource(icons.get(1));
        packet2.setBackgroundTintList(ColorStateList.valueOf(colors.get(1)));
        packet2.setClickable(true);
        packet2.setOnClickListener(new OnPacket2ButtonClickListener());
        packet2.setOnLongClickListener(new OnButtonLongClickListener());
        packet2.setScaleX(0);
        packet2.setScaleY(0);
        packet2.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
        addView(packet2);

        packet3 = new FloatingActionButton(context);
        packet3.setImageResource(icons.get(2));
        packet3.setBackgroundTintList(ColorStateList.valueOf(colors.get(2)));
        packet3.setClickable(true);
        packet3.setOnClickListener(new OnPacket3ButtonClickListener());
        packet3.setOnLongClickListener(new OnButtonLongClickListener());
        packet3.setScaleX(0);
        packet3.setScaleY(0);
        packet3.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
        addView(packet3);


        packet4 = new FloatingActionButton(context);
        packet4.setImageResource(icons.get(3));
        packet4.setBackgroundTintList(ColorStateList.valueOf(colors.get(3)));
        packet4.setClickable(true);
        packet4.setOnClickListener(new OnPacket4ButtonClickListener());
        packet4.setOnLongClickListener(new OnButtonLongClickListener());
        packet4.setScaleX(0);
        packet4.setScaleY(0);
        packet4.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
        addView(packet4);

        packet5 = new FloatingActionButton(context);
        packet5.setImageResource(icons.get(4));
        packet5.setBackgroundTintList(ColorStateList.valueOf(colors.get(4)));
        packet5.setClickable(true);
        packet5.setOnClickListener(new OnPacket5ButtonClickListener());
        packet5.setOnLongClickListener(new OnButtonLongClickListener());
        packet5.setScaleX(0);
        packet5.setScaleY(0);
        packet5.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
        addView(packet5);


        packet6 = new FloatingActionButton(context);
        packet6.setImageResource(icons.get(5));
        packet6.setBackgroundTintList(ColorStateList.valueOf(colors.get(4)));
        packet6.setClickable(true);
        packet6.setOnClickListener(new OnPacket6ButtonClickListener());
        packet6.setOnLongClickListener(new OnButtonLongClickListener());
        packet6.setScaleX(0);
        packet6.setScaleY(0);
        packet6.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
        addView(packet6);
    ...
    public void Packet1()
    {
        mButtons.add(packet1);
    }

    public void Packet2()
    {
        mButtons.add(packet2);
    }

    public void Packet3()
    {
        mButtons.add(packet3);
    }

    public void Packet4()
    {
        mButtons.add(packet4);
    }
    public void Packet5()
    {
        mButtons.add(packet5);
    }

    public void Packet6()
    {
        mButtons.add(packet6);
    }

    public void setParemetrs(int id)
    {
        this.id=id;
    }
